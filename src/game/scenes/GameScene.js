...
export class GameScene extends Phaser.Scene {
  ...
  update(time, delta) {
    ...
    this.tunnelRenderer.draw(this.gfx, activeFaceVertex, this._rotAngle);
    this.entityRenderer.draw(this.gfx, this.state, this.entityManager, VISUAL_OFFSET, this._rotAngle, bulletLerp);
